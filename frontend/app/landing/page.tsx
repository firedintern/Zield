    ...
    <main style={{ background: 'var(--z-bg-0)', color: 'var(--z-text-primary)' }} className="min-h-screen">
      ...
      <section className="relative overflow-hidden pt-28 pb-20 px-6 text-center"
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-16">
          <Link href="/"
            ...
            style={{ background: 'var(--z-accent)', color: '#0a0b0f' }}>
            Deposit USDC <ChevronRight size={16} />
          </Link>
          <a href="#how"
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <FeatureCard
            ...
            body="Aave v3 supply rates are read directly from the Base mainnet pool contract every 6 hours. No oracle assumptions, no stale feeds."
          />
          <FeatureCard
            icon={RefreshCw}
      ...
      <section id="how" className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="flex flex-col gap-8">
          ...
          <StepCard n={2} title="Engine scans protocols"
            body="Every 6 hours the risk engine reads live APY from Aave v3 on-chain and scans DefiLlama for emerging opportunities on Base." />
      ...
      <section className="text-center px-6 py-24"
        ...
        <Link href="/"
          ...
          style={{ background: 'var(--z-accent)', color: '#0a0b0f' }}>
          Open the vault <ArrowRight size={16} />
        </Link>
      </section>
      ...
      <footer className="border-t px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs"
        ...
        <div className="flex gap-4">
          <Link href="/" style={{ color: 'var(--z-text-tertiary)' }}>App</Link>
